...
export const wishQuestions = [
  ...
  { id: 10, category: '食事', title: "グレードは？",
    ...
    optionB: { key: 'luxury', label: '贅沢・高級', img: 'https://images.unsplash.com/photo-1550966871-3ed3cdb51f3a?q=80&w=600' } },
  // レジャー（体験の性質）
  ...
  { id: 12, category: 'レジャー', title: "過ごし方は？",
    ...
    optionB: { key: 'relax', label: 'リラックス', img: 'https://images.unsplash.com/photo-1526491109672-7474bd61c41f?q=80&w=600' } },
